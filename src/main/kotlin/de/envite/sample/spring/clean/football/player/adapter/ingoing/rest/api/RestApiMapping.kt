...
internal fun PlayerRecordResource.toPlayerRecord() =
    PlayerRecord(
        player = this.player.toPlayer(),
        attributes = this.attributes.map { it.toPlayerAttributes() }.toList()
    )

internal fun PlayerResource.toPlayer() =
    Player(
        playerId = PlayerId(this.id),
        playerFifaApiId = PlayerFifaApiId(this.fifaApiId),
        playerApiId = PlayerApiId(this.apiId),
...
internal fun PlayerAttributesResource.toPlayerAttributes() =
    PlayerAttributes(
